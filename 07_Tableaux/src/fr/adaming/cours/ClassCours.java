...
public class ClassCours {
	...
	public static void main(String[] args) {
		...
		//creation d'un tableau initialisé
		int[] tab2 = {1,2,3,4,5};
		
		//remplir tableau grace à la boucle for
		...
		//lire un tableau grace à la boucle for each, pour chaque "elem" du tableau tab2 il va faire quelque chose 
		for (int elem : tab1) {
